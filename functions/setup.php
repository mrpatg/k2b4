...
if ( ! function_exists('k2b4_setup') ) {
	function k2b4_setup() {

		// Gutenberg
		add_theme_support( 'wp-block-styles' );

		// k2b4 cannot support extra-wide blocks
...
add_action('init', 'k2b4_setup');

if ( ! function_exists( 'k2b4_avatar_attributes' ) ) {
	function k2b4_avatar_attributes($avatar_attributes) {
...
add_filter('get_avatar','k2b4_avatar_attributes');

if ( ! function_exists( 'k2b4_author_avatar' ) ) {
	function k2b4_author_avatar() {

		echo get_avatar('', $size = '96');
	}
}

if ( ! function_exists( 'k2b4_author_description' ) ) {
	function k2b4_author_description() {
		echo get_the_author_meta('user_description');
	}
}

if ( ! function_exists( 'k2b4_post_date' ) ) {
	function k2b4_post_date() {
