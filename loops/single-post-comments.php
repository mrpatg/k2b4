        ...
        <form action="<?php echo site_url('/wp-comments-post.php') ?>" method="post" id="commentform">
          ...
          <?php else : ?>
            ...
            <div class="form-group">
              <label for="author"><?php _e('Your name', 'k2b4');
                                  if ($req) echo ' <span class="text-muted">' . __('(required)', 'k2b4') . '</span>'; ?></label>
            ...
            <div class="form-group">
              <label for="email"><?php _e('Your email address', 'k2b4');
                                  if ($req) echo '&nbsp;<span class="text-muted">' . _e('(required, but will not be published)', 'k2b4') . '</span>'; ?></label>
